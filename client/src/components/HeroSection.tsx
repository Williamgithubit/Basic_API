        ...
        <div>
          ...
          <ul className="space-y-2 mb-8">
            <li className="flex items-center text-gray-800">
              <FaCar className="text-blue-600 mr-2" /> Wide range of vehicles to choose from
            </li>
            <li className="flex items-center text-gray-800">
              <FaCalendarAlt className="text-blue-600 mr-2" /> Book by the day, week or month
            </li>
            <li className="flex items-center text-gray-800">
              <FaMapMarkerAlt className="text-blue-600 mr-2" /> Pickup from multiple locations
            </li>
          </ul>
          <Link
            to="/cars"
