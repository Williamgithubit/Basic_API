...
const ReduxExample = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            // Transform the API response to match the expected User type
            dispatch(loginSuccess({
                ...
                user: {
                    ...
                    phone: '', // Add a default value since the API doesn't provide this
