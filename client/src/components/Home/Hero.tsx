          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Experience the future of transportation. Safe, reliable, and convenient rides at your fingertips. Join millions who trust RideShare for their daily commute.
              </p>
            </div>
